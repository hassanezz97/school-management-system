        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <h6 style="color: red;font-family: Cairo">{{trans('Students_trans.current_Stage')}}</h6><br>

                    <form method="post" action="{{ route('Promotion.store') }}">
                        @csrf
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputState">{{trans('Students_trans.current_Grade')}}</label>
                            ...
                            <div class="form-group col">
                                <label for="Classroom_id">{{trans('Students_trans.current_classroom')}} : <span
                            ...
                            <div class="form-group col">
                                <label for="section_id">{{trans('Students_trans.current_section')}} : </label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col">
                                <label for="Classroom_id">{{trans('Students_trans.new_classrooms')}}: <span
                                        class="text-danger">*</span></label>
