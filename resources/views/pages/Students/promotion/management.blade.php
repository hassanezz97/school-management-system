...
@section('css')
    @toastr_css
@section('title')
    {{trans('Students_trans.Manage-Promotions')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                        ...
                        <div class="card card-statistics h-100">
                            <div class="card-body">
                                ...
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#Delete_all">
                                    {{trans('Students_trans.undo-promotions')}}
                                </button>
                                <br><br>
                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        <tr>
                                            ...
                                            <th class="alert-danger">{{trans('Students_trans.old-stage')}}</th>
                                            <th class="alert-danger">{{trans('Students_trans.old-year')}}</th>
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-outline-danger" data-toggle="modal" data-target="#Delete_one{{$promotion->id}}">{{trans('Students_trans.unprompted-student')}}</button>
                                                    <button type="button" class="btn btn-outline-success" data-toggle="modal" data-target="#">{{trans('Students_trans.graduated-student')}}</button>
                                                </td>
                                            </tr>
