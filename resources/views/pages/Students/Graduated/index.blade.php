                                    ...
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($students as $student)
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#Return_Student{{ $student->id }}" title="{{trans('Students_trans.unprompted-student') }}">{{trans('Students_trans.unprompted-student') }}</button>
