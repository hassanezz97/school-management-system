...
@section('css')
    @toastr_css
@section('title')
    {{trans('Students_trans.ed-ac-fees')}}
@stop
@endsection
@section('page-header')
    <!-- breadcrumb -->
                    ...
                    <form action="{{route('Fees.update','test')}}" method="post" autocomplete="off">
                        ...
                        <div class="form-row">
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('Students_trans.fee-name-ar')}}</label>
                            ...
                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('Students_trans.fee-name-en')}}</label>
                                <input type="text" value="{{$fee->getTranslation('title','en')}}" name="title_en" class="form-control">
                            </div>


                            <div class="form-group col">
                                <label for="inputEmail4">{{trans('Students_trans.Price')}}</label>
